...
const FeatureCard = ({ icon, title, desc }) => (
    <div className="flex items-start gap-4 p-5 rounded-2xl bg-white/60 border border-slate-200/80 backdrop-blur-sm hover:border-emerald-300 hover:shadow-md transition-all duration-300">
        <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-emerald-50 border border-emerald-200 flex items-center justify-center text-emerald-700">
            {icon}
        </div>
        <div>
        ...
        <div className="flex flex-col w-full min-h-screen bg-slate-50">
            ...
            >
                ...
                <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
                    <div className="absolute -top-24 -right-24 w-[480px] h-[480px] rounded-full opacity-20"
                        style={{ background: 'radial-gradient(circle, #6ee7b7, transparent 70%)' }} />
                    <div className="absolute bottom-0 -left-16 w-[320px] h-[320px] rounded-full opacity-15"
                ...
                <div className="container mx-auto px-6 lg:px-12 py-20 grid md:grid-cols-2 gap-16 items-center">
                    <div className="space-y-7">
                        ...
                        <div>
                            <h1 className="text-5xl md:text-6xl lg:text-7xl font-black text-slate-800 leading-[1.05] tracking-tight">
                                SIMPAS
                            </h1>
                            <p className="mt-2 text-slate-500 font-medium text-base tracking-widest uppercase">
                        ...
                        <div className="flex flex-wrap gap-3 pt-1">
                            <Link
                                href={route('register')}
                                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-emerald-700 text-white font-semibold text-sm hover:bg-emerald-800 active:scale-95 transition-all duration-200 shadow-lg shadow-emerald-900/20"
                            >
                                Mulai Sekarang
                            ...
                            <a
                                href="#tentang"
                                className="inline-flex items-center gap-2 px-6 py-3 rounded-xl border border-slate-300 text-slate-700 font-semibold text-sm hover:bg-white hover:border-slate-400 transition-all duration-200"
                            >
                                Pelajari Lebih
                            </a>
                        </div>
                        ...
                        <div className="flex gap-8 pt-4 border-t border-slate-200">
                            {[
                                ...
                                <div key={s.label}>
                                    <p className="text-2xl font-black text-slate-800">{s.num}</p>
                    ...
                    <div className="relative">
                        ...
                        <div className="rounded-[1.75rem] overflow-hidden ring-1 ring-slate-200 shadow-2xl">
                            <Swiper
                        ...
                        {/* Floating badge */}
                        <div className="absolute -bottom-4 -left-4 bg-white rounded-2xl px-4 py-3 shadow-lg border border-slate-100 flex items-center gap-3">
            ...
            {/* ─── KATEGORI ─── */}
            <section id="kategori" className="bg-white py-20 px-6 border-t border-slate-100">
                <div className="container mx-auto">
                    <div className="text-center mb-12">
                        <span className="text-xs font-bold uppercase tracking-widest text-emerald-700">Koleksi Kami</span>
                        <h2 className="text-3xl font-black text-slate-800 mt-2">Jelajahi Kategori Buku</h2>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                        {categories.slice(0, 6).map((item, idx) => (
                                <div
                                    key={item.id || idx}
                                    className="group flex flex-col items-center justify-center gap-3 p-5 rounded-2xl border border-slate-200 bg-slate-50 hover:bg-emerald-50 hover:border-emerald-300 transition-all duration-300 cursor-default"
                                >
                                    <div className="w-11 h-11 rounded-xl bg-white group-hover:bg-emerald-100 border border-slate-200 group-hover:border-emerald-200 flex items-center justify-center transition-colors duration-300">
                                    ...
                                    <span className="text-xs font-semibold text-slate-700 group-hover:text-emerald-800 text-center transition-colors duration-300">
                                        {item.name}
                                    </span>
                                </div>
                            ))}
            ...
            {/* ─── TENTANG ─── */}
            <section id="tentang" className="py-24 px-6 overflow-hidden" style={{ background: 'linear-gradient(160deg, #f1f5f2 0%, #eaf0ea 100%)' }}>
                <div className="container mx-auto grid md:grid-cols-2 items-center gap-16">
                    <div className="relative">
                        ...
                        <div className="rounded-[1.5rem] overflow-hidden ring-1 ring-slate-200 shadow-xl">
                            <Swiper
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <h2 className="text-3xl font-black text-slate-800 mt-2 leading-tight">
                                Perpustakaan <br />SMAN 2 Siborongborong
                            </h2>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-3 pt-2">
                            {[
                                {
                                    title: 'Koleksi Terintegrasi',
                                    desc: 'Buku digital dan cetak tersedia dalam satu platform.'
                                },
                                {
                                    title: 'Akses 24/7',
                                    desc: 'Seluruh siswa dan guru dapat membaca kapan saja.'
                                },
                                {
                                    title: 'Peminjaman Efisien',
                                    desc: 'Sistem peminjaman dan pengembalian yang terkomputerisasi.'
                                },
                            ].map((f) => (
